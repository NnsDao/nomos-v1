                ...
                <div className="product">
                    ...
                    <div className="product-info">
                        <div className="flex flex-col justify-start items-start mb-100px">
                            ...
                            <p>Opportunity mapping is most useful when done in early discovery — when you and your team and trying to figure out what features, brand moments, or other items you’re trying to emphasize or transform within any user journey.</p>
                        </div>
                        <div className="flex flex-col justify-start items-start">
                            ...
                            <p>Now, think about your problemspace. What types of opportunities dows your team want to focus on? These could be brand moments, communication opportunities with a user type, really anything that pertains to your work! This is a flexible resource on purpose.
                                Lastly, work with your team to fill in the rows!</p>
                        </div>
                    </div>
                    ...
                    <div >
                        <div className="product-item">
                            ...
                            <div><Avatar size={186} /></div>
                            <div style={{ fontSize: '42px', color: '#FFFFFF' }}>Icpsan</div>
                            <div className="my-12"> <img src={img} alt="" width={'156px'} height={'282px'} /></div>
                            <div className="flex flex-col justify-around items-start">
                                <div className="flex justify-center items-center">
                                    <div><img src={alltasks} alt="" width={'36px'} height={'36px'} /></div>
                                    <div>alltasks</div>
                                </div>
                                <div className="flex justify-center items-center my-12" >
                                    <div><img src={design} alt="" width={'36px'} height={'36px'} /></div>
                                    <div>design</div>
                                </div>
                                <div className="flex justify-center items-center ">
                                    <div><img src={dev} alt="" width={'36px'} height={'36px'} /></div>
                                    <div>dev</div>
                                </div>
                            </div>
