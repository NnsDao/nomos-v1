            ...
            <div className={"w-full  mx-auto min-h-screen flex flex-col flex-wrap items-center bg-primary pb-32"}>
                ...
                <div className="introduction-wrapper">
                    <div className="flex flex-col justify-center items-center">
                        <div className="text-7xl my-32 w-9/12 ">
                            Introduction à la notion de grille
                        </div>
                        <div className="w-9/12 text-left mb-40">
                            <p className="mb-6">Bien que les grilles proviennent des imprimés, elles trouvent leur application partout autour de nous, de l'architecture à l'ingénierie.
                                Une grille bien conçue peut fournir une structure et une cohérence, aider à mettre de l'ordre dans le chaos et créer une disposition plus harmonieuse.
                                Les interfaces n'étant plus rigides, nos systèmes de grille ne le sont plus également. Les grilles sont idéales pour concevoir des interfaces dynamiques au-delà d'un seul support ou d'une seule taille d'écran.
                                De la plus petite à la plus grande, les grilles vous couvrent.</p>
                            <p className="mb-6">Une grille se compose de trois éléments : des colonnes (ou lignes), des Espace intercolonnes (gutters) et des marges. Pour la mise en œuvre, il est préférable de définir chacun d'entre eux à l'aide de pourcentages, plutôt que de valeurs fixes. Cela permettra au contenu de s'adapter dynamiquement à n'importe quelle taille d'écran.
                                Les colonnes de la grille comportent du contenu :</p>
                    ...
                    <div className={'w-1/2 flex justify-between items-start  text-white '}>
                        <img src={marketplace} width={"20%"} alt="" />
                        <img src={window} width={"20%"} alt="" />
                        <img src={google} width={"20%"} alt="" />
                        <img src={app} width={"20%"} alt="" />
                    </div>
                </div>
            </div>
        </>
