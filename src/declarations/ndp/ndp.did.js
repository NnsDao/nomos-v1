export const idlFactory = ({ IDL }) => {
  ...
  const NDPInfo = IDL.Record({ balance: IDL.Nat, claim: IDL.Nat });
  ...
  const NDPTest = IDL.Service({
    ...
    addOwner: IDL.Func([IDL.Principal], [Result_2], ['query']),
    allBalances: IDL.Func([], [IDL.Vec(IDL.Tuple(IDL.Text, Balance))], ['query']),
    ...
    owner: IDL.Func([], [IDL.Vec(IDL.Tuple(IDL.Principal, IDL.Nat64))], ['query']),
